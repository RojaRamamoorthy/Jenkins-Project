...
class Add(Tk):
    def __init__(self):
        ...
        Label(self, text='Book Details', fg='black', font=('Book Antiqua', 25, 'bold')).pack()
        Label(self, text='').pack()
        Label(self, text='Book Id:', font=('Book Antiqua', 10, 'bold')).place(x=100, y=130)
        Entry(self, textvariable=a, width=30).place(x=230, y=132)
        Label(self, text='Book Name:', font=('Book Antiqua', 10, 'bold')).place(x=100, y=180)
        Entry(self, textvariable=b, width=30).place(x=230, y=182)
        Label(self, text='Book Author:', font=('Book Antiqua', 10, 'bold')).place(x=100, y=230)
