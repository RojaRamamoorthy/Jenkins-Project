...
class Rem(Tk):
    def __init__(self):
        ...
        Label(self, text = "Enter User Id: ",font=('Times New Roman', 15, 'bold')).place(x = 20,y = 40)
        Entry(self,textvariable = a,width = 37).place(x = 160,y = 44)
        Button(self, text='Remove', width=15, font=('Times New Roman', 10),command = ent).place(x=200, y = 90)
