...
class renew(Tk):
    def __init__(self):
        ...
        Label(self, text='Renew Book',  fg='black',font=('Times New Roman', 35, 'bold')).pack()
        Label(self, text='Enter Book ID',font=('Times New Roman', 15, 'bold')).place(x=80, y=150)
        Entry(self, textvariable=a, width=40).place(x=280, y=150)
        Label(self, text="Enter Student Id",font=('Times New Roman', 15, 'bold')).place(x=80, y=200)
