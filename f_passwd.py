...
class Fp(Tk):
    def __init__(self):
            ...
            if len(a.get()) < 5:
                ...
                try:
                    ...
                    if not pc:
                        ...
                        Label(self, text="New Password", font=('Georgia', 15, 'bold')).place(x=40, y=220)
                        Entry(self, show = "*", textvariable=d, width=40).place(x=230, y=224)
                        Label(self, text="Retype Password", font=('Georgia', 15, 'bold')).place(x=40, y=270)
        ...
        #label and input box
        Label(self, text="Enter User Id", font=('Georgia', 15, 'bold')).place(x=40, y=20)
        Label(self, text="Security Question",font=('Georgia', 15, 'bold')).place(x=40, y= 70)
        Label(self, text="Security Answer",font=('Georgia', 15, 'bold')).place(x=40, y= 120)
