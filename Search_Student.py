...
class Sst(Tk):
    def __init__(self):
        ...
        l1=Label(self,text="Search Student",font=("Times New Roman",20,'bold')).place(x=290,y=20)
        l = Label(self, text="Search By", font=("Times New Roman", 15, 'bold')).place(x=60, y=96)
...
#clicking the record will open the picture
        ...
        b=Button(self,text="Find",width=15,font=("Times New Roman",10,'bold'),command=ge).place(x=460,y=148)
